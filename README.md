...
- **Logging:** A `TransactionLog` entry is created with a `PENDING` state _before_ the transaction begins, ensuring we have a record of every attempted disbursement.
